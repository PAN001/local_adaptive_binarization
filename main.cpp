...
void NiblackSauvolaWolfJolion_serial (Mat im, Mat im_sum, Mat im_sum_sq, double min_I, double max_I, Mat output, NiblackVersion version,
...
int main (int argc, char **argv)
{
    ...
    int N = 5;
    char* file_names[] = {"../250_250_plate_149_80.jpg", "../640_360_plate_346_172.jpg", "../1024_1024_plate_160_120.jpg", "../1920_1080_plate_1441_719.jpeg", "../2048_1536_plate_1226_612.jpg"};
    ...
    for(int i = 0;i < N;i++) {
        ...
        endTime;
        getTimeMonotonic(&endTime);
        cout << "=========== Serial Time: " << diffclock(startTime, endTime) << "ms." << endl;
